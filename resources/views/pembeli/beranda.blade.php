            ...
            ?>
                <div class="card" style="width: 19rem; margin:12px">
                    ...
                    <div class="card-body">
                        ...
                        <h6 class="card-title"><span class="fa fa-map-marker"></span> {{$dt->lokasi}}</h6>
                        <div class="row">
                            <div class="col-6">
                                <h6 class="card-title"><span class="fa fa-calendar"></span> {{date('d-m-Y', strtotime($dt->tanggal_konser))}}</h6>
                            </div>
                            <div class="col-6">
                                <h6 class="card-title"><span class="fa fa-ticket"></span> {{$dt->tiket}} Tiket</h6>
                            </div>
                        </div>
                        <hr>
                        <!-- Button trigger modal -->
                        <button type="button" class="btn btn-primary col-12" data-bs-toggle="modal" data-bs-target="#exampleModal{{ $dt->id_konser }}">
                            <span class="fa fa-paper-plane"></span> Pesan Sekarang
                        </button>
                        <!-- Modal -->
                                            ...
                                            <div class="row">
                                                <div class="col-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" class="form-control" id="jenis_bank" name="jenis_bank" value="{{ $dt->jenis_bank }}" disabled>
                                                    </div>
                                                    <div class=" mb-3">
                                                        <label class="form-label"><b>Atas Nama</b></label>
                                                        <input type="text" class="form-control" id="atas_nama" name="atas_nama" value="{{ $dt->atas_nama }}" disabled>
                                                    </div>
                                                    <div class="mb-3">
                                                        <label class="form-label"><b>No Rekening</b></label>
                                                        <input type="number" class="form-control" id="rekening" name="rekening" value="{{ $dt->rekening }}" disabled>
                                                    </div>
                                                </div>
                                                <div class="col-6" style="border-left: 1px solid black;">
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" class="form-control" id="harga{{$dt->id_konser}}" name="harga" value="{{$dt->harga}}" disabled>
                                                    </div>
                                                    <div class="mb-3">
                                                        <label class="form-label"><b>Qty</b></label>
                                                        <input type="number" class="form-control" id="qty{{$dt->id_konser}}" name="qty" value="1">
                                                    </div>
                                                    <div class="mb-3">
                                                        <label class="form-label"><b>Total</b></label>
                                                        <h3 name="total"></h3>
                                                        <input type="text" class="form-control" id="total{{$dt->id_konser}}" name="total">
                                                    </div>
                                                    <div class="mb-3">
                                                        <label class="form-label"><b>Bukti Transfer</b></label>
                                                        <input type="file" class="form-control" id="transfer" name="transfer">
                                                    </div>
