            ...
            <div class="modal-dialog modal-dialog-centered modal-lg">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="/tambahKonser" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                                <div class="col-4">
                                    <div class="mb-3">
            ...
            <tbody>
                ...
                ?>
                    <tr>
                        ...
                        <td>
                            <!-- Button trigger modal -->
                            <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModal{{ $dt->id_konser }}">
                                <span class="fa fa-info-circle"></span>
                            </button>
                            <!-- Modal -->
                            <div class="modal fade" id="exampleModal{{ $dt->id_konser }}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                <div class="modal-dialog modal-dialog-centered modal-lg">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            ...
                                            <form action="/updateKonser" method="POST" enctype="multipart/form-data">
                                                ...
                                                <div class="row">
                                                    <div class="col-4">
                                                        <div class="mb-3">
                                                            <label class="form-label"><b>Gambar</b></label>
                                                            <img src="/assets/img/poster/{{$dt->image}}" class="card-img-top" alt="..." style="height: 300px;">
                                                        </div>
                                                    </div>
                                                    <div class="col-8" style="border-left: 1px solid black;">
                                                        <div class="mb-3">
                                                            <label class="form-label"><b>Nama Konser</b></label>
                                                            <input type="text" class="form-control" id="nama_konser" name="nama_konser" value="{{ $dt->nama_konser }}">
                                                        </div>
                                                        <div class="mb-3">
                                                            <label class="form-label"><b>Tanggal</b></label>
                                                            <input type="date" class="form-control" id="tanggal_konser" name="tanggal_konser" value="{{ $dt->tanggal_konser }}">
                                                        </div>
                                                        <div class="mb-3">
                                                            <label class="form-label"><b>Lokasi</b></label>
                                                            <input type="text" class="form-control" id="lokasi" name="lokasi" value="{{ $dt->lokasi }}">
                                                        </div>
                                                        <div class="mb-3">
                                                            <label class="form-label"><b>Harga Tiket</b></label>
                                                            <input type="number" class="form-control" id="harga" name="harga" value="{{ $dt->harga }}">
                                                        </div>
                                                        <div class="mb-3">
                                                            <label class="form-label"><b>Jumlah Tiket</b></label>
                                                            <input type="number" class="form-control" id="tiket" name="tiket" value="{{ $dt->tiket }}">
                                                        </div>

                                                        <div class="mb-3">
                                                            <label class="form-label"><b>Jenis Bank</b></label>
                                                            <input type="text" class="form-control" id="jenis_bank" name="jenis_bank" value="{{ $dt->jenis_bank }}">
                                                        </div>
                                                        <div class="mb-3">
                                                            <label class="form-label"><b>Atas Nama</b></label>
                                                            <input type="text" class="form-control" id="atas_nama" name="atas_nama" value="{{ $dt->atas_nama }}">
                                                        </div>
                                                        <div class="mb-3">
                                                            <label class="form-label"><b>No Rekening</b></label>
                                                            <input type="number" class="form-control" id="rekening" name="rekening" value="{{ $dt->rekening }}">
                                                        </div>
                            ...
                            <!-- Button trigger modal -->
                            <button type="button" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#ModalDelete{{ $dt->id_konser }}">
                                <span class="fa fa-trash"></span>
                            </button>
                            <!-- Modal -->
                            <div class="modal fade" id="ModalDelete{{ $dt->id_konser }}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                <div class="modal-dialog modal-dialog-centered">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form action="/deleteKonser" method="POST">
                                                @csrf
                                                <h6>Apakah Anda Yakin Akan Menghapus Konser "{{$dt->nama_konser}}"?</h6>
                                                <input type="hidden" id="id_konser" name="id_konser" value="{{ $dt->id_konser }}">
                                                <input type="hidden" id="image" name="image" value="{{ $dt->image }}">
                                                <div class="modal-footer">
                                                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Tutup</button>
